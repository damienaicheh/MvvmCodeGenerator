...
![Visual Studio File Viewer](./Documentation/project_not_structured.png)

As you can see the *.g.cs* files are not grouped with their *.cs* implementation. To resolve this problem, just go to your *.csproj* associated to your project and add this line to import the *.g.targets* generated by MvvmCodeGenerator:

```xml
<Import Project="MvvmCodeGenMapper.g.targets" />
```

Relaod your project and you will see something like this:
